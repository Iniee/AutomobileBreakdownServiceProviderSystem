...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4 mb-4 order-0">
            <a href="{{ route('client-view-client') }}">
                <div class="card">
                    <div class="d-flex flex-row">
                        <div class="col-sm-6">
                            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4 order-0">
            <a href="{{ route('provider-view-provider') }}">
                <div class="card">
                    <div class="d-flex flex-row">
                        <div class="col-sm-6">
                            <div class="card-body">
                                <h5 class="card-title text-dark">TOTAL SERVICE PROVIDERS</h5>
        ...
        <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
            <div class="card">
                <div class="row row-bordered g-0">
                    <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Total Breakdown</h5>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="text-center fw-semibold pt-3 mb-2">Client Growth</div>
        ...
        <div class="col-12 col-md-8 col-lg-4 order-3 order-md-2">
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <a href="{{ route('trans-client-transaction') }}">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <a class="dropdown-item" href="{{ route('trans-client-transaction') }}">View More</a>
                                ...
                                <h5 class="text-nowrap mb-2">Transactions</h5>
                                <h3 class="card-title mb-2">
                                    {!! '&#8358;' !!}{{ number_format(DB::table('fund_wallets')->where('processor_response', 'successful')->sum('charged_amount') - DB::table('fund_wallets')->where('processor_response', 'debit')->sum('charged_amount'),2,'.',',') }}
                                </h3>
        ...
        <div class="row"> -->
                <div class="col-12 mb-4">
                    <a href="{{ route('trans-service-charges') }}">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                        ...
                                        <div class="mt-sm-auto">
                                            ...
                                            <h3 class="mb-0">{!! '&#8358;' !!}{{ DB::table('diagnoses')->sum('cost') }}</h3>
                                        </div>
                                    </div>
